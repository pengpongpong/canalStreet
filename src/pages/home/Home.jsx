...
const marketDescription = [
  { imageSrc: "/images/pages-images/home/canalStreetMarket.jpg", imageAlt: "Canal Street Market", description: "Merging retail, food, art, and culture, Canal Street Market highlights top retail and design concepts, restaurants, and up-and-coming players in the downtown New York City community." },
  { imageSrc: "/images/pages-images/home/retailMarket.jpg", imageAlt: "Retail Market", description: `Retail Market Hours:\nFri– Sun: 11:00AM - 7:00PM` },
  { imageSrc: "/images/pages-images/home/foodHall.jpg", imageAlt: "Food Hall", description: `Food Hall Hours:\nMon – Sun: 11:00AM - 8:00PM` }
]
  ...
  return (
    <PageContainer bgColor={bgColor}>
      ...
      <section className="address">
        ...
        />
        <AddressBox
          element={<img className="address__map" src={`/images/pages-images/home/map.png`}></img>}
        />
      </section>
