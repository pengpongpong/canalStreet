    ...
    return (
        <PageContainer>
            <div className="policy">
                ...
                <p className="policy__text">This privacy notice discloses the privacy practices for https://canalstreet.market/. This privacy notice applies solely to information collected by this website. It will notify you of the following:</p>
